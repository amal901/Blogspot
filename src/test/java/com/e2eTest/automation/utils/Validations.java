...
public class Validations extends BasePage {
	...
	public void assertEquals(WebElement element, String text) {
		...
		System.out.println("xxxxxxxxxxx"+text1);
	...
	public void assertTrueBoolean(WebElement element) {
		Assert.assertTrue("Checkbox should be selected", isElementSelected(element));

	}
	
	public void assertTrueBooleanDisplayed(WebElement element) {
		Assert.assertTrue("Checkbox should be displayed", isElementDisplayed(element));

	}
	
	public void assertcolor(WebElement element) {
		Assert.assertTrue("Checkbox should be selected", isElementSelected(element));
...
//			 if (!isSelected) {
//				 
//		            log.info("The checkbox " + element + " is not selected.");
//			 }
//		            else {
//		                log.info("The checkbox " + element + " is selected.");
//		            
//			 }
//			return isSelected;
//		}
